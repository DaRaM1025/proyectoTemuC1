...
/**
 * Servicio para la gestión de productos tipo Televisor.
 * <p>
 * Esta clase administra una lista de {@link TelevisorDTO}, permitiendo inicializar,
 * clonar, leer desde almacenamiento persistente y obtener sublistas o listas completas de televisores.
 * </p>
 * <p>
...
public class TelevisorService {
    ...
    /** Lista que almacena los productos tipo Televisor disponibles */
    private List<TelevisorDTO> listaTelevisores;

    /**
     * Inicializa la lista de televisores con datos de ejemplo y sincroniza con el DAO.
     * <p>
    ...
    /**
     * Sincroniza la lista de televisores con el DAO persistente.
     * <p>
     * Convierte los {@link TelevisorDTO} a entidades y los agrega al DAO.
     * </p>
     */
    ...
    /**
     * Lee la lista de televisores desde el DAO persistente y la convierte a DTO.
     */
    ...
    /**
     * Obtiene la lista completa de televisores.
     * 
     * @return {@link List} de {@link TelevisorDTO} con todos los productos
     */
    ...
    /**
     * Obtiene una sublista de televisores o una lista aleatoria si el tamaño solicitado
     * es mayor al tamaño disponible.
     * 
     * @param size Número de productos a obtener
     * @return {@link List} de {@link TelevisorDTO} con los productos seleccionados
     */
     ...
     * @return {@link List} de {@link TelevisorDTO} con los productos clonados y con ID único
     */
