...
/**
 * Servicio para la gestión de productos de tipo {@link CalzadoDTO}.
 * <p>
 * Esta clase proporciona métodos para inicializar, obtener, clonar y sincronizar
 * la lista de calzados con la capa de persistencia {@link ModelFacade}.
 * </p>
 * <p>
 * Se utiliza en un contexto de aplicación y está disponible como bean gestionado
 * de CDI mediante la anotación {@link Named} y {@link ApplicationScoped}.
 * </p>
 */
@Named
@ApplicationScoped
public class CalzadoService {
    ...
    /** Lista de calzados en memoria */
    private List<CalzadoDTO> listaCalzados;

    /**
     * Inicializa la lista de calzados con datos predefinidos y sincroniza con
    ...
    /**
     * Devuelve la lista completa de calzados.
     *
     * @return {@link List} de {@link CalzadoDTO} con todos los productos
     */
    ...
    /**
     * Devuelve una lista de calzados con un tamaño determinado.
     * <p>
     ...
     * @return {@link List} de {@link CalzadoDTO} con los productos seleccionados
     */
    ...
    /**
     * Sincroniza la lista de calzados en memoria con la capa de persistencia.
     */
    ...
    /**
     * Carga los calzados desde la persistencia y actualiza la lista en memoria.
     */
    ...
    /**
     * Devuelve una lista de productos clonados, garantizando códigos únicos.
     *
     * @param size Número de productos a clonar
     * @return {@link List} de {@link CalzadoDTO} clonados con IDs únicos
     */
