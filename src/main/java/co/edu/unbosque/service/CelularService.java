...
/**
 * Servicio para la gestión de celulares.
 * <p>
 * Esta clase administra una lista de {@link CelularDTO}, permitiendo inicializar, clonar,
 * leer desde almacenamiento persistente, y obtener sublistas o listas completas de productos.
 * </p>
 * <p>
...
public class CelularService {
    ...
    /** Lista que almacena los celulares disponibles */
    private List<CelularDTO> listaCelulares;

    /**
     * Inicializa la lista de celulares con datos de ejemplo y sincroniza con el DAO.
     * <p>
    ...
    /**
     * Sincroniza la lista de celulares con el DAO persistente.
     * <p>
     * Convierte los {@link CelularDTO} a entidades y los agrega al DAO.
     * </p>
     */
    ...
    /**
     * Lee la lista de celulares desde el DAO persistente y la convierte a DTO.
     */
    ...
    /**
     * Obtiene la lista completa de celulares.
     * 
     * @return {@link List} de {@link CelularDTO} con todos los celulares
     */
    ...
    /**
     * Obtiene una sublista de celulares o una lista aleatoria si el tamaño solicitado
     * es mayor al tamaño disponible.
     * 
     * @param size Número de celulares a obtener
     * @return {@link List} de {@link CelularDTO} con los celulares seleccionados
     */
    ...
    /**
     * Clona los celulares obtenidos y asegura códigos únicos.
     * 
     * @param size Número de celulares a clonar
     * @return {@link List} de {@link CelularDTO} con los celulares clonados y con ID único
     */
