...
/**
 * Servicio para la gestión de productos tipo Pistola de Agua.
 * <p>
 * Esta clase administra una lista de {@link PistolaAguaDTO}, permitiendo inicializar,
 * clonar, leer desde almacenamiento persistente y obtener sublistas o listas completas de pistolas de agua.
 * </p>
 * <p>
...
public class PistolaAguaService {
    ...
    /** Lista que almacena los productos tipo Pistola de Agua disponibles */
    private List<PistolaAguaDTO> listaPistolasAgua;

    /**
     * Inicializa la lista de pistolas de agua con datos de ejemplo y sincroniza con el DAO.
     * <p>
    ...
    /**
     * Sincroniza la lista de pistolas de agua con el DAO persistente.
     * <p>
     * Convierte los {@link PistolaAguaDTO} a entidades y los agrega al DAO.
     * </p>
     */
    ...
    /**
     * Lee la lista de pistolas de agua desde el DAO persistente y la convierte a DTO.
     */
    ...
    /**
     * Obtiene la lista completa de pistolas de agua.
     * 
     * @return {@link List} de {@link PistolaAguaDTO} con todos los productos
     */
    ...
    /**
     * Obtiene una sublista de pistolas de agua o una lista aleatoria si el tamaño solicitado
     * es mayor al tamaño disponible.
     * 
     * @param size Número de productos a obtener
     * @return {@link List} de {@link PistolaAguaDTO} con los productos seleccionados
     */
     ...
     * @return {@link List} de {@link PistolaAguaDTO} con los productos clonados y con ID único
     */
