...
/**
 * Servicio para la gestión de computadores.
 * <p>
 * Esta clase administra una lista de {@link ComputadorDTO}, permitiendo inicializar,
...
public class ComputadorService {
    ...
    /** Lista que almacena los computadores disponibles */
    private List<ComputadorDTO> listaComputadores;

    /**
     * Inicializa la lista de computadores con datos de ejemplo y sincroniza con el DAO.
     * <p>
    ...
    /**
     * Sincroniza la lista de computadores con el DAO persistente.
     * <p>
     * Convierte los {@link ComputadorDTO} a entidades y los agrega al DAO.
     * </p>
     */
    ...
    /**
     * Lee la lista de computadores desde el DAO persistente y la convierte a DTO.
     */
    ...
    /**
     * Obtiene la lista completa de computadores.
     * 
     * @return {@link List} de {@link ComputadorDTO} con todos los computadores
     */
    ...
    /**
     * Obtiene una sublista de computadores o una lista aleatoria si el tamaño solicitado
     * es mayor al tamaño disponible.
     * 
     * @param size Número de computadores a obtener
     * @return {@link List} de {@link ComputadorDTO} con los productos seleccionados
     */
    ...
    /**
     * Clona los computadores obtenidos y asegura códigos únicos.
     * 
     * @param size Número de computadores a clonar
     * @return {@link List} de {@link ComputadorDTO} con los productos clonados y con ID único
     */
