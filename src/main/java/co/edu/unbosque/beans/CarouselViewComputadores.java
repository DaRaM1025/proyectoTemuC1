...
/**
 * Clase que gestiona la vista de carrusel para productos de computadores
...
public class CarouselViewComputadores implements Serializable {
    /**
     * Lista de productos de computadores
     */
    ...
    /**
     * Servicio para manejar operaciones de computadores
     */
    @Inject
    ...
    /**
     * Obtiene la lista de productos de computadores
    ...
    /**
     * Establece el servicio de computadores
