...
/**
 * Clase que gestiona la vista de carrusel para productos de celulares
...
public class CarouselViewCelulares implements Serializable {
    /**
     * Lista de productos de celulares
     */
    ...
    /**
     * Servicio para manejar operaciones de celulares
     */
    @Inject
    ...
    /**
     * Obtiene la lista de productos de celulares
    ...
    /**
     * Establece el servicio de celulares
