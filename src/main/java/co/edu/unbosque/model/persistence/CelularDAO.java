...
public class CelularDAO implements OperacionDAO<CelularDTO, Celular> {
	...
	public void escribirEnArchivo() {
		...
		for (int i = 0; i < listaCelular.size(); i++) {
			contenido += listaCelular.get(i).getNombre() + ";";
			contenido += listaCelular.get(i).getMarca() + ";";
			contenido += listaCelular.get(i).getTipoProducto() + ";";
			contenido += listaCelular.get(i).getDescripcion() + ";";
			contenido += listaCelular.get(i).getUrlImagen() + ";";
			contenido += listaCelular.get(i).getPrecio() + ";";
			contenido += listaCelular.get(i).getCantidad() + ";";
			contenido += listaCelular.get(i).getId() + ";";
			contenido += listaCelular.get(i).getPulgadas() + ";";
			contenido += listaCelular.get(i).getResolucion() + ";";
			contenido += listaCelular.get(i).getSistemaOperativo() + ";";
			contenido += listaCelular.get(i).getAlmacenamiento() + ";";
			contenido += listaCelular.get(i).getRam() + ";";
			contenido += listaCelular.get(i).getCantidadCamaras() + ";";
			contenido += listaCelular.get(i).isDualSim() + "\n";
		}
